...
export function normalizeTransactionFilters(filters: TransactionViewFilters): TransactionViewFilters {
  const normalized: TransactionViewFilters = {
...
export function parseTransactionFilters(searchParams: SearchParamsLike): TransactionViewFilters {
...
export function applyTransactionFiltersToSearchParams(searchParams: SearchParamsLike, filters: TransactionViewFilters) {
...
export function countActiveTransactionFilterGroups(filters: TransactionViewFilters) {
  const normalizedFilters = normalizeTransactionFilters(filters);
