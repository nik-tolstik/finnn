      ...
      >
        ...
        <div className="mt-auto space-y-2 border-t px-4 py-4">
          ...
          <div className="relative" ref={userMenuRef}>
            ...
            {userMenuOpen && (
              <div className="absolute bottom-0 left-full z-50 ml-2 w-72 rounded-md bg-popover p-2 text-card-foreground shadow-md">
                <div>
                  <button
                    type="button"
                    onClick={() => {
                ...
                <div className="px-2 py-2">
                  <AppearanceSettings title="Интерфейс" className="space-y-2" showLabels={false} />
                </div>
