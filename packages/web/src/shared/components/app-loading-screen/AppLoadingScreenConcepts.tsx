...
const LEFT_MARK_PATH =
  "M180.789 266C170.489 266 162.875 266.447 157.949 267.342C152.574 267.79 146.752 269.804 140.482 273.383C133.764 276.963 129.062 283.004 126.375 291.506C123.688 300.008 122.344 311.419 122.344 325.738C122.344 340.057 123.688 351.468 126.375 359.97C129.062 368.472 133.764 374.513 140.482 378.093C147.2 381.225 153.246 383.239 158.62 384.134C163.547 384.581 171.384 384.805 182.133 384.805H387.699V452.598H255.357C244.609 452.598 236.771 453.045 231.845 453.94C226.471 454.387 220.425 456.401 213.707 459.981C202.062 466.693 196.24 484.368 196.24 513.007C196.24 544.33 204.75 562.9 221.768 568.718C228.934 570.955 240.354 572.074 256.029 572.074H387.699V698.933C387.699 709.673 388.147 717.503 389.043 722.426C389.491 727.348 391.506 733.165 395.089 739.877C401.359 751.959 418.825 758 447.488 758C478.838 758 497.2 749.498 502.574 732.494C505.261 725.334 506.605 713.924 506.605 698.262V325.067C506.605 302.246 502.35 286.808 493.841 278.753C485.332 270.251 469.209 266 445.473 266H180.789Z";

const RIGHT_MARK_PATH =
...
function AnimatedLogo({ concept }: { concept: Concept }) {
  ...
  return (
    <svg
      ...
      className={`${styles.logo} ${styles[concept]}`}
      aria-hidden="true"
      focusable="false"
    >
      {drawsNThenBars ? (
...
export function SvgPathDrawSplash(props: AppLoadingScreenConceptProps) {
  return <AppLoadingScreenConcept concept="pathDraw" {...props} />;
}

export function SvgPathAssemblySplash(props: AppLoadingScreenConceptProps) {
  return <AppLoadingScreenConcept concept="pathAssembly" {...props} />;
}
