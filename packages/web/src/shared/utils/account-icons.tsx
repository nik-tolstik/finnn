...
function BynIcon({ className, ...props }: ComponentProps<"svg">) {
  return (
    <svg viewBox="0 0 700 700" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} {...props}>
      <path
        fill="currentColor"
...
export const ACCOUNT_ICON_DEFINITIONS = {
  ...
  BYN: { Icon: BynIcon, colorMode: "adaptive" },
