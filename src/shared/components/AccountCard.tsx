...
export function AccountCard({ account, className, onClick, showOwner = true }: AccountCardProps) {
  ...
  const cardTint = hasColor ? hexToRgba(account.color as string, 0.2) : "rgba(255, 255, 255, 0.05)";
  ...
  const cardClassName = cn(
    "relative flex w-full flex-col overflow-hidden rounded-xl border text-left text-card-foreground shadow-sm backdrop-blur-md backdrop-saturate-150",
